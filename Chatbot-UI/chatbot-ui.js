...
function init() {
    ...
    //--------------------------- Important Variables----------------------------
    var inactiveMessage = "Désolé, je suis actuellement indisponible. Veuillez réessayer plus tard. Merci !"
...
function chatbotTheme(theme) {
    ...
    const green = {
        color: "#4CAF50",
        background: "linear-gradient(19deg, #2E8B57 0%, #00FF7F 100%)"
    }

    const pink = {
        color: "#E91E63",
        background: "linear-gradient(19deg, #FF80AB 0%, #E91E63 100%)"
    }
    const yellow = {
        color: "#FFC107",
        background: "linear-gradient(19deg, #FFD54F 0%, #FFC107 100%)"
    }
    ...
    if (theme === "orange") {
        ...
        chatSubmit.style.backgroundColor = green.color;
    } else if (theme === "pink") {
        ...
        root.style.setProperty('--chat-window-color-theme', yellow.color);
        gradientHeader.style.backgroundImage = yellow.background;
        chatSubmit.style.backgroundColor = yellow.color;
    }
